...
# store output
mkdir("seed=18___tracetype=bwd_inv_irf___target=Cross___kernel=MF.RWMH")
CSV.write("seed=18___tracetype=bwd_inv_irf___target=Cross___kernel=MF.RWMH/summary.csv", df)
