...
# store output
mkdir("seed=3___tracetype=mcmc___target=WarpedGaussian___kernel=MF.RWMH")
CSV.write("seed=3___tracetype=mcmc___target=WarpedGaussian___kernel=MF.RWMH/summary.csv", df)
