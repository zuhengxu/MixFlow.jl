...
# store output
mkdir("seed=29___tracetype=fwd_irf___target=Banana___kernel=MF.MALA")
CSV.write("seed=29___tracetype=fwd_irf___target=Banana___kernel=MF.MALA/summary.csv", df)
