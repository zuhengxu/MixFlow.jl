...
# store output
mkdir("seed=19___tracetype=fwd_homo___target=WarpedGaussian___kernel=MF.MALA")
CSV.write("seed=19___tracetype=fwd_homo___target=WarpedGaussian___kernel=MF.MALA/summary.csv", df)
