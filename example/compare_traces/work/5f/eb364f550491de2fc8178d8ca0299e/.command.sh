...
# store output
mkdir("seed=21___tracetype=bwd_inv_irf___target=Cross___kernel=MF.HMC")
CSV.write("seed=21___tracetype=bwd_inv_irf___target=Cross___kernel=MF.HMC/summary.csv", df)
