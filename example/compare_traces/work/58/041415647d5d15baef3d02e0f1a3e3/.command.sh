...
# store output
mkdir("seed=10___tracetype=fwd_irf___target=WarpedGaussian___kernel=MF.RWMH")
CSV.write("seed=10___tracetype=fwd_irf___target=WarpedGaussian___kernel=MF.RWMH/summary.csv", df)
