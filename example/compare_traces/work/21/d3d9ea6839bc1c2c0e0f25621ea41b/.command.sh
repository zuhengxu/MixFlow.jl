...
# store output
mkdir("seed=2___tracetype=fwd_homo___target=Banana___kernel=MF.MALA")
CSV.write("seed=2___tracetype=fwd_homo___target=Banana___kernel=MF.MALA/summary.csv", df)
