...
# store output
mkdir("seed=26___target=Funnel___flowtype=MF.DeterministicMixFlow___kernel=MF.HMC___step_size=0.2___flow_length=200")
CSV.write("seed=26___target=Funnel___flowtype=MF.DeterministicMixFlow___kernel=MF.HMC___step_size=0.2___flow_length=200/summary.csv", df)
