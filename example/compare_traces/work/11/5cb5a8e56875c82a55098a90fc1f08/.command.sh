...
# store output
mkdir("seed=8___tracetype=fwd_homo___target=Funnel___kernel=MF.RWMH")
CSV.write("seed=8___tracetype=fwd_homo___target=Funnel___kernel=MF.RWMH/summary.csv", df)
