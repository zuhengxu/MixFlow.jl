...
# store output
mkdir("seed=2___kernel=MF.HMC___step_size=0.1___flow_length=50___target=WarpedGaussian___flowtype=MF.IRFMixFlow")
CSV.write("seed=2___kernel=MF.HMC___step_size=0.1___flow_length=50___target=WarpedGaussian___flowtype=MF.IRFMixFlow/summary.csv", df)
