...
# store output
mkdir("seed=15___tracetype=fwd_irf___target=Banana___kernel=MF.MALA")
CSV.write("seed=15___tracetype=fwd_irf___target=Banana___kernel=MF.MALA/summary.csv", df)
