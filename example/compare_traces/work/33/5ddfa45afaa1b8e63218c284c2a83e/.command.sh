...
# store output
mkdir("seed=29___tracetype=bwd_irf___target=Funnel___kernel=MF.MALA")
CSV.write("seed=29___tracetype=bwd_irf___target=Funnel___kernel=MF.MALA/summary.csv", df)
