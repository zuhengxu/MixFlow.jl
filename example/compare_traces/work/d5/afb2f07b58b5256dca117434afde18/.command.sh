...
# store output
mkdir("seed=11___tracetype=fwd_homo___target=WarpedGaussian___kernel=MF.MALA")
CSV.write("seed=11___tracetype=fwd_homo___target=WarpedGaussian___kernel=MF.MALA/summary.csv", df)
