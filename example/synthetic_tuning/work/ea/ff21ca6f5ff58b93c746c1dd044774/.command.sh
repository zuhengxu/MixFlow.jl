...
# store output
mkdir("seed=1___target=Cross___flowtype=MF.DeterministicMixFlow___kernel=MF.MALA___step_size=0.1___flow_length=3000")
CSV.write("seed=1___target=Cross___flowtype=MF.DeterministicMixFlow___kernel=MF.MALA___step_size=0.1___flow_length=3000/summary.csv", df)
