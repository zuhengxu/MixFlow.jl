...
# store output
mkdir("seed=9___tracetype=fwd_homo___target=WarpedGaussian___kernel=MF.RWMH")
CSV.write("seed=9___tracetype=fwd_homo___target=WarpedGaussian___kernel=MF.RWMH/summary.csv", df)
