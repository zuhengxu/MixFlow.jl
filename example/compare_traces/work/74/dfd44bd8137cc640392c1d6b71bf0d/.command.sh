...
# store output
mkdir("seed=24___tracetype=fwd_irf___target=WarpedGaussian___kernel=MF.MALA")
CSV.write("seed=24___tracetype=fwd_irf___target=WarpedGaussian___kernel=MF.MALA/summary.csv", df)
