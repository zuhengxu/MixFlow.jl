...
# store output
mkdir("seed=16___tracetype=inv_irf___target=WarpedGaussian___kernel=MF.HMC")
CSV.write("seed=16___tracetype=inv_irf___target=WarpedGaussian___kernel=MF.HMC/summary.csv", df)
