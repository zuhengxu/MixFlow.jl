...
# store output
mkdir("seed=24___tracetype=bwd_irf___target=Banana___kernel=MF.MALA")
CSV.write("seed=24___tracetype=bwd_irf___target=Banana___kernel=MF.MALA/summary.csv", df)
