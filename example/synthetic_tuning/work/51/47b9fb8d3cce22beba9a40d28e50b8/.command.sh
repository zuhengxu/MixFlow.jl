...
# store output
mkdir("seed=3___target=Funnel___flowtype=MF.DeterministicMixFlow___kernel=MF.RWMH___step_size=0.1___flow_length=3000")
CSV.write("seed=3___target=Funnel___flowtype=MF.DeterministicMixFlow___kernel=MF.RWMH___step_size=0.1___flow_length=3000/summary.csv", df)
