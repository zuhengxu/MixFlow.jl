...
# store output
mkdir("seed=25___tracetype=fwd_homo___target=Banana___kernel=MF.MALA")
CSV.write("seed=25___tracetype=fwd_homo___target=Banana___kernel=MF.MALA/summary.csv", df)
