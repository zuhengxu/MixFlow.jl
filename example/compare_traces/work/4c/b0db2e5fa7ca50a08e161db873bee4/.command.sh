...
# store output
mkdir("seed=18___tracetype=fwd_irf___target=Funnel___kernel=MF.MALA")
CSV.write("seed=18___tracetype=fwd_irf___target=Funnel___kernel=MF.MALA/summary.csv", df)
