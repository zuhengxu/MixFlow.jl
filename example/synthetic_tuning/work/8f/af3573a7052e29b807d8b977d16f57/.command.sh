...
# store output
mkdir("seed=8___target=WarpedGaussian___flowtype=MF.IRFMixFlow___kernel=MF.HMC___step_size=0.1___flow_length=200")
CSV.write("seed=8___target=WarpedGaussian___flowtype=MF.IRFMixFlow___kernel=MF.HMC___step_size=0.1___flow_length=200/summary.csv", df)
