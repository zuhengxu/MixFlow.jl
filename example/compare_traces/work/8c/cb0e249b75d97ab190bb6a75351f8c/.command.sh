...
# store output
mkdir("seed=15___tracetype=fwd_homo___target=Funnel___kernel=MF.MALA")
CSV.write("seed=15___tracetype=fwd_homo___target=Funnel___kernel=MF.MALA/summary.csv", df)
