...
# store output
mkdir("seed=20___tracetype=bwd_inv_irf___target=Banana___kernel=MF.MALA")
CSV.write("seed=20___tracetype=bwd_inv_irf___target=Banana___kernel=MF.MALA/summary.csv", df)
