...
# store output
mkdir("seed=7___tracetype=bwd_inv_irf___target=Banana___kernel=MF.MALA")
CSV.write("seed=7___tracetype=bwd_inv_irf___target=Banana___kernel=MF.MALA/summary.csv", df)
