...
# store output
mkdir("seed=11___kernel=MF.HMC___step_size=0.2___flow_length=150___target=Cross___flowtype=MF.BackwardIRFMixFlow")
CSV.write("seed=11___kernel=MF.HMC___step_size=0.2___flow_length=150___target=Cross___flowtype=MF.BackwardIRFMixFlow/summary.csv", df)
