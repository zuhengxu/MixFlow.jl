...
# store output
mkdir("seed=7___target=Funnel___flowtype=MF.IRFMixFlow___kernel=MF.HMC___step_size=0.2___flow_length=200")
CSV.write("seed=7___target=Funnel___flowtype=MF.IRFMixFlow___kernel=MF.HMC___step_size=0.2___flow_length=200/summary.csv", df)
