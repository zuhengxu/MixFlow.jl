...
# store output
mkdir("seed=7___tracetype=mcmc___target=WarpedGaussian___kernel=MF.HMC")
CSV.write("seed=7___tracetype=mcmc___target=WarpedGaussian___kernel=MF.HMC/summary.csv", df)
