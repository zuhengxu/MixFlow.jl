...
# store output
mkdir("seed=4___tracetype=fwd_homo___target=WarpedGaussian___kernel=MF.HMC")
CSV.write("seed=4___tracetype=fwd_homo___target=WarpedGaussian___kernel=MF.HMC/summary.csv", df)
