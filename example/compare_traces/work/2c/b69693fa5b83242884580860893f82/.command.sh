...
# store output
mkdir("seed=25___tracetype=fwd_homo___target=Banana___kernel=MF.HMC")
CSV.write("seed=25___tracetype=fwd_homo___target=Banana___kernel=MF.HMC/summary.csv", df)
