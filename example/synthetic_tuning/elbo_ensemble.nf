...
process run_simulation {
    ...
    # run simulation
    df = ensemble_sample_eval(seed, name, flow_length, nchains, kernel, step_size; nsample = ${params.n_sample}, leapfrog_steps=20)
