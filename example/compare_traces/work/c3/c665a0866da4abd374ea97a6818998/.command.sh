...
# store output
mkdir("seed=23___tracetype=inv_irf___target=WarpedGaussian___kernel=MF.HMC")
CSV.write("seed=23___tracetype=inv_irf___target=WarpedGaussian___kernel=MF.HMC/summary.csv", df)
