...
# store output
mkdir("seed=31___tracetype=bwd_inv_irf___target=Banana___kernel=MF.HMC")
CSV.write("seed=31___tracetype=bwd_inv_irf___target=Banana___kernel=MF.HMC/summary.csv", df)
