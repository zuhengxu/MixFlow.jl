...
# store output
mkdir("seed=3___target=Cross___flowtype=MF.IRFMixFlow___kernel=MF.RWMH___step_size=0.05___flow_length=2000")
CSV.write("seed=3___target=Cross___flowtype=MF.IRFMixFlow___kernel=MF.RWMH___step_size=0.05___flow_length=2000/summary.csv", df)
