...
# store output
mkdir("seed=24___kernel=MF.HMC___step_size=0.2___flow_length=150___target=Funnel___flowtype=MF.BackwardIRFMixFlow")
CSV.write("seed=24___kernel=MF.HMC___step_size=0.2___flow_length=150___target=Funnel___flowtype=MF.BackwardIRFMixFlow/summary.csv", df)
