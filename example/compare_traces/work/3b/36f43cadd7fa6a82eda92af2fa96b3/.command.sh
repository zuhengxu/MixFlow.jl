...
# store output
mkdir("seed=15___tracetype=bwd_irf___target=Funnel___kernel=MF.MALA")
CSV.write("seed=15___tracetype=bwd_irf___target=Funnel___kernel=MF.MALA/summary.csv", df)
