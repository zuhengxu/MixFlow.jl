...
# store output
mkdir("seed=24___tracetype=mcmc___target=WarpedGaussian___kernel=MF.MALA")
CSV.write("seed=24___tracetype=mcmc___target=WarpedGaussian___kernel=MF.MALA/summary.csv", df)
