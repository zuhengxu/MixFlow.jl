...
# store output
mkdir("seed=16___tracetype=fwd_homo___target=Cross___kernel=MF.RWMH")
CSV.write("seed=16___tracetype=fwd_homo___target=Cross___kernel=MF.RWMH/summary.csv", df)
