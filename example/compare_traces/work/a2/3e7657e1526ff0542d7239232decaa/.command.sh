...
# store output
mkdir("seed=18___tracetype=fwd_homo___target=Funnel___kernel=MF.HMC")
CSV.write("seed=18___tracetype=fwd_homo___target=Funnel___kernel=MF.HMC/summary.csv", df)
