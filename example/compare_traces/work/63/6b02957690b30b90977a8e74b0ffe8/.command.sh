...
# store output
mkdir("seed=26___tracetype=fwd_irf___target=WarpedGaussian___kernel=MF.HMC")
CSV.write("seed=26___tracetype=fwd_irf___target=WarpedGaussian___kernel=MF.HMC/summary.csv", df)
