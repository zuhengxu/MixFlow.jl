...
# store output
mkdir("seed=1___tracetype=fwd_homo___target=WarpedGaussian___kernel=MF.HMC")
CSV.write("seed=1___tracetype=fwd_homo___target=WarpedGaussian___kernel=MF.HMC/summary.csv", df)
