...
# store output
mkdir("seed=1___tracetype=mcmc___target=WarpedGaussian___kernel=MF.HMC")
CSV.write("seed=1___tracetype=mcmc___target=WarpedGaussian___kernel=MF.HMC/summary.csv", df)
