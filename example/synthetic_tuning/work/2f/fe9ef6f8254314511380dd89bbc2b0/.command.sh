...
# store output
mkdir("seed=1___target=Banana___flowtype=MF.DeterministicMixFlow___kernel=MF.MALA___step_size=0.05___flow_length=2000")
CSV.write("seed=1___target=Banana___flowtype=MF.DeterministicMixFlow___kernel=MF.MALA___step_size=0.05___flow_length=2000/summary.csv", df)
