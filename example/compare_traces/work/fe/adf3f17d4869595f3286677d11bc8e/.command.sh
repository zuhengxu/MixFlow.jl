...
# store output
mkdir("seed=15___tracetype=bwd_inv_irf___target=Funnel___kernel=MF.HMC")
CSV.write("seed=15___tracetype=bwd_inv_irf___target=Funnel___kernel=MF.HMC/summary.csv", df)
