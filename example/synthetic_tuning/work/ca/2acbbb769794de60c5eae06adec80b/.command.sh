...
# store output
mkdir("seed=29___target=Banana___flowtype=MF.IRFMixFlow___kernel=MF.HMC___step_size=0.01___flow_length=200")
CSV.write("seed=29___target=Banana___flowtype=MF.IRFMixFlow___kernel=MF.HMC___step_size=0.01___flow_length=200/summary.csv", df)
