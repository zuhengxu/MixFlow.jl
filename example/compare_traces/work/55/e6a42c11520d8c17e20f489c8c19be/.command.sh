...
# store output
mkdir("seed=6___tracetype=mcmc___target=WarpedGaussian___kernel=MF.HMC")
CSV.write("seed=6___tracetype=mcmc___target=WarpedGaussian___kernel=MF.HMC/summary.csv", df)
