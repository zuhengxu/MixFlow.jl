...
# store output
mkdir("seed=3___target=Banana___flowtype=MF.BackwardIRFMixFlow___kernel=MF.RWMH___step_size=1.0___flow_length=2000")
CSV.write("seed=3___target=Banana___flowtype=MF.BackwardIRFMixFlow___kernel=MF.RWMH___step_size=1.0___flow_length=2000/summary.csv", df)
