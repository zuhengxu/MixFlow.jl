...
# store output
mkdir("seed=25___tracetype=fwd_irf___target=Banana___kernel=MF.RWMH")
CSV.write("seed=25___tracetype=fwd_irf___target=Banana___kernel=MF.RWMH/summary.csv", df)
