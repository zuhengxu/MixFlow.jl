...
# store output
mkdir("seed=13___tracetype=bwd_irf___target=Banana___kernel=MF.RWMH")
CSV.write("seed=13___tracetype=bwd_irf___target=Banana___kernel=MF.RWMH/summary.csv", df)
