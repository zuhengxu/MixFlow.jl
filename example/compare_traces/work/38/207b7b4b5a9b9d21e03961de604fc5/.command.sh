...
# store output
mkdir("seed=11___tracetype=fwd_homo___target=Banana___kernel=MF.RWMH")
CSV.write("seed=11___tracetype=fwd_homo___target=Banana___kernel=MF.RWMH/summary.csv", df)
