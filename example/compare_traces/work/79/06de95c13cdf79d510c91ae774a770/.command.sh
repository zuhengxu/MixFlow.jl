...
# store output
mkdir("seed=14___tracetype=mcmc___target=WarpedGaussian___kernel=MF.HMC")
CSV.write("seed=14___tracetype=mcmc___target=WarpedGaussian___kernel=MF.HMC/summary.csv", df)
