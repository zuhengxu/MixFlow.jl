...
# store output
mkdir("seed=15___tracetype=bwd_irf___target=WarpedGaussian___kernel=MF.RWMH")
CSV.write("seed=15___tracetype=bwd_irf___target=WarpedGaussian___kernel=MF.RWMH/summary.csv", df)
