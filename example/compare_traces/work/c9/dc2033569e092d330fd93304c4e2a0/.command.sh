...
# store output
mkdir("seed=12___tracetype=fwd_irf___target=Banana___kernel=MF.RWMH")
CSV.write("seed=12___tracetype=fwd_irf___target=Banana___kernel=MF.RWMH/summary.csv", df)
