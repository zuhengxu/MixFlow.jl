...
# store output
mkdir("seed=27___tracetype=mcmc___target=WarpedGaussian___kernel=MF.MALA")
CSV.write("seed=27___tracetype=mcmc___target=WarpedGaussian___kernel=MF.MALA/summary.csv", df)
