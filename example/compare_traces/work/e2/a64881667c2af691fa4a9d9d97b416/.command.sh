...
# store output
mkdir("seed=3___tracetype=mcmc___target=WarpedGaussian___kernel=MF.MALA")
CSV.write("seed=3___tracetype=mcmc___target=WarpedGaussian___kernel=MF.MALA/summary.csv", df)
