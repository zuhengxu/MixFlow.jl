...
# store output
mkdir("seed=28___tracetype=bwd_inv_irf___target=Cross___kernel=MF.MALA")
CSV.write("seed=28___tracetype=bwd_inv_irf___target=Cross___kernel=MF.MALA/summary.csv", df)
