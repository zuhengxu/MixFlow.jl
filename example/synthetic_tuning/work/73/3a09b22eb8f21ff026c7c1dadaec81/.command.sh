...
# store output
mkdir("seed=1___target=Funnel___flowtype=MF.DeterministicMixFlow___kernel=MF.MALA___step_size=0.5___flow_length=300")
CSV.write("seed=1___target=Funnel___flowtype=MF.DeterministicMixFlow___kernel=MF.MALA___step_size=0.5___flow_length=300/summary.csv", df)
