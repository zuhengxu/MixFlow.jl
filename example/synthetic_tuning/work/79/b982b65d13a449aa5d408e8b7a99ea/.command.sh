...
# store output
mkdir("seed=4___target=Banana___flowtype=MF.BackwardIRFMixFlow___kernel=MF.HMC___step_size=0.05___flow_length=200")
CSV.write("seed=4___target=Banana___flowtype=MF.BackwardIRFMixFlow___kernel=MF.HMC___step_size=0.05___flow_length=200/summary.csv", df)
