...
# store output
mkdir("seed=30___tracetype=inv_irf___target=Banana___kernel=MF.RWMH")
CSV.write("seed=30___tracetype=inv_irf___target=Banana___kernel=MF.RWMH/summary.csv", df)
