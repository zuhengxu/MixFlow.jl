...
# store output
mkdir("seed=30___tracetype=mcmc___target=WarpedGaussian___kernel=MF.MALA")
CSV.write("seed=30___tracetype=mcmc___target=WarpedGaussian___kernel=MF.MALA/summary.csv", df)
