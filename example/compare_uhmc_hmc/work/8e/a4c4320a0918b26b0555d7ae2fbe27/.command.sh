...
# store output
mkdir("seed=5___target=Banana___flowtype=MF.DeterministicMixFlow___kernel=MF.HMC___step_size=0.1___flow_length=300")
CSV.write("seed=5___target=Banana___flowtype=MF.DeterministicMixFlow___kernel=MF.HMC___step_size=0.1___flow_length=300/summary.csv", df)
