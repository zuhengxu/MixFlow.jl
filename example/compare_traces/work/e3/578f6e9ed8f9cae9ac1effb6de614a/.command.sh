...
# store output
mkdir("seed=25___tracetype=inv_irf___target=WarpedGaussian___kernel=MF.MALA")
CSV.write("seed=25___tracetype=inv_irf___target=WarpedGaussian___kernel=MF.MALA/summary.csv", df)
