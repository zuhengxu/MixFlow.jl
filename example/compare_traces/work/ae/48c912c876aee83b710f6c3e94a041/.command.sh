...
# store output
mkdir("seed=22___tracetype=mcmc___target=WarpedGaussian___kernel=MF.MALA")
CSV.write("seed=22___tracetype=mcmc___target=WarpedGaussian___kernel=MF.MALA/summary.csv", df)
