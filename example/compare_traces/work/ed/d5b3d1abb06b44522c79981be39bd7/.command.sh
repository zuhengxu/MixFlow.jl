...
# store output
mkdir("seed=13___tracetype=bwd_inv_irf___target=Cross___kernel=MF.MALA")
CSV.write("seed=13___tracetype=bwd_inv_irf___target=Cross___kernel=MF.MALA/summary.csv", df)
