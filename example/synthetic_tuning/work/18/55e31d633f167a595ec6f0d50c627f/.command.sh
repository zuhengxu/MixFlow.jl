...
# store output
mkdir("seed=23___kernel=MF.HMC___step_size=0.2___flow_length=150___target=Funnel___flowtype=MF.DeterministicMixFlow")
CSV.write("seed=23___kernel=MF.HMC___step_size=0.2___flow_length=150___target=Funnel___flowtype=MF.DeterministicMixFlow/summary.csv", df)
