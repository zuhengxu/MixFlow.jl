...
# store output
mkdir("seed=1___tracetype=bwd_inv_irf___target=WarpedGaussian___kernel=MF.RWMH")
CSV.write("seed=1___tracetype=bwd_inv_irf___target=WarpedGaussian___kernel=MF.RWMH/summary.csv", df)
