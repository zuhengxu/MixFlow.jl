...
# store output
mkdir("seed=10___tracetype=mcmc___target=WarpedGaussian___kernel=MF.MALA")
CSV.write("seed=10___tracetype=mcmc___target=WarpedGaussian___kernel=MF.MALA/summary.csv", df)
