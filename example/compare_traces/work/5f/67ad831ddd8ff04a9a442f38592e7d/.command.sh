...
# store output
mkdir("seed=30___tracetype=bwd_inv_irf___target=WarpedGaussian___kernel=MF.HMC")
CSV.write("seed=30___tracetype=bwd_inv_irf___target=WarpedGaussian___kernel=MF.HMC/summary.csv", df)
