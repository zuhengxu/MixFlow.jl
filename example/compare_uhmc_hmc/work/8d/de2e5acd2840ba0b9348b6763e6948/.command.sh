...
# store output
mkdir("seed=1___target=Cross___flowtype=MF.DeterministicMixFlow___kernel=MF.HMC___step_size=0.1___flow_length=300")
CSV.write("seed=1___target=Cross___flowtype=MF.DeterministicMixFlow___kernel=MF.HMC___step_size=0.1___flow_length=300/summary.csv", df)
