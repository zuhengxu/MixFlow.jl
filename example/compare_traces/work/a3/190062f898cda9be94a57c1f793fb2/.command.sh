...
# store output
mkdir("seed=19___tracetype=fwd_irf___target=Banana___kernel=MF.RWMH")
CSV.write("seed=19___tracetype=fwd_irf___target=Banana___kernel=MF.RWMH/summary.csv", df)
