...
# store output
mkdir("seed=6___tracetype=bwd_inv_irf___target=Cross___kernel=MF.MALA")
CSV.write("seed=6___tracetype=bwd_inv_irf___target=Cross___kernel=MF.MALA/summary.csv", df)
