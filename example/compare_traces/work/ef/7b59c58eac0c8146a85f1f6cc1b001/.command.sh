...
# store output
mkdir("seed=11___tracetype=mcmc___target=WarpedGaussian___kernel=MF.HMC")
CSV.write("seed=11___tracetype=mcmc___target=WarpedGaussian___kernel=MF.HMC/summary.csv", df)
