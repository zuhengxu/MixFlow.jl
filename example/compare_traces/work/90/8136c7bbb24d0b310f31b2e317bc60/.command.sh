...
# store output
mkdir("seed=2___tracetype=mcmc___target=WarpedGaussian___kernel=MF.HMC")
CSV.write("seed=2___tracetype=mcmc___target=WarpedGaussian___kernel=MF.HMC/summary.csv", df)
