...
# store output
mkdir("seed=7___kernel=MF.HMC___step_size=0.2___flow_length=150___target=Cross___flowtype=MF.DeterministicMixFlow")
CSV.write("seed=7___kernel=MF.HMC___step_size=0.2___flow_length=150___target=Cross___flowtype=MF.DeterministicMixFlow/summary.csv", df)
