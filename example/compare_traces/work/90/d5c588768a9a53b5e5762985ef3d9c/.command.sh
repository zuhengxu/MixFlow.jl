...
# store output
mkdir("seed=13___tracetype=bwd_inv_irf___target=WarpedGaussian___kernel=MF.HMC")
CSV.write("seed=13___tracetype=bwd_inv_irf___target=WarpedGaussian___kernel=MF.HMC/summary.csv", df)
