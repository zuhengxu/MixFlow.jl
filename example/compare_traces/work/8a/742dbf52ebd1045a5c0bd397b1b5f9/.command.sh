...
# store output
mkdir("seed=32___tracetype=bwd_irf___target=WarpedGaussian___kernel=MF.HMC")
CSV.write("seed=32___tracetype=bwd_irf___target=WarpedGaussian___kernel=MF.HMC/summary.csv", df)
