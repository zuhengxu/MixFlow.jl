...
# store output
mkdir("seed=28___target=Cross___flowtype=MF.IRFMixFlow___kernel=MF.HMC___step_size=0.2___flow_length=200")
CSV.write("seed=28___target=Cross___flowtype=MF.IRFMixFlow___kernel=MF.HMC___step_size=0.2___flow_length=200/summary.csv", df)
