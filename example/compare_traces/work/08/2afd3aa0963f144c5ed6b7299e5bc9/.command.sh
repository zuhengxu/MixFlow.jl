...
# store output
mkdir("seed=6___tracetype=mcmc___target=WarpedGaussian___kernel=MF.MALA")
CSV.write("seed=6___tracetype=mcmc___target=WarpedGaussian___kernel=MF.MALA/summary.csv", df)
