...
# store output
mkdir("seed=25___tracetype=fwd_homo___target=WarpedGaussian___kernel=MF.HMC")
CSV.write("seed=25___tracetype=fwd_homo___target=WarpedGaussian___kernel=MF.HMC/summary.csv", df)
