...
# store output
mkdir("seed=1___target=Banana___flowtype=MF.DeterministicMixFlow___kernel=MF.RWMH___step_size=0.2___flow_length=1500")
CSV.write("seed=1___target=Banana___flowtype=MF.DeterministicMixFlow___kernel=MF.RWMH___step_size=0.2___flow_length=1500/summary.csv", df)
