...
# store output
mkdir("seed=20___tracetype=fwd_homo___target=Funnel___kernel=MF.RWMH")
CSV.write("seed=20___tracetype=fwd_homo___target=Funnel___kernel=MF.RWMH/summary.csv", df)
