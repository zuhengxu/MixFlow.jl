...
# store output
mkdir("seed=27___tracetype=bwd_inv_irf___target=WarpedGaussian___kernel=MF.RWMH")
CSV.write("seed=27___tracetype=bwd_inv_irf___target=WarpedGaussian___kernel=MF.RWMH/summary.csv", df)
