...
# store output
mkdir("seed=9___target=Banana___flowtype=real_nvp___lr=1e-3___batchsize=64___niters=50000")
CSV.write("seed=9___target=Banana___flowtype=real_nvp___lr=1e-3___batchsize=64___niters=50000/summary.csv", df)
