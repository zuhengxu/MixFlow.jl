...
# store output
mkdir("seed=17___tracetype=fwd_homo___target=Cross___kernel=MF.RWMH")
CSV.write("seed=17___tracetype=fwd_homo___target=Cross___kernel=MF.RWMH/summary.csv", df)
