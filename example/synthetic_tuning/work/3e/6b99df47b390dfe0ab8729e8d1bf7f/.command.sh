...
# store output
mkdir("seed=1___target=Funnel___flowtype=MF.DeterministicMixFlow___kernel=MF.MALA___step_size=0.1___flow_length=1500")
CSV.write("seed=1___target=Funnel___flowtype=MF.DeterministicMixFlow___kernel=MF.MALA___step_size=0.1___flow_length=1500/summary.csv", df)
