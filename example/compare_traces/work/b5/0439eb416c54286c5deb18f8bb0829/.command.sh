...
# store output
mkdir("seed=9___tracetype=mcmc___target=WarpedGaussian___kernel=MF.HMC")
CSV.write("seed=9___tracetype=mcmc___target=WarpedGaussian___kernel=MF.HMC/summary.csv", df)
