...
# store output
mkdir("seed=2___tracetype=mcmc___target=WarpedGaussian___kernel=MF.RWMH")
CSV.write("seed=2___tracetype=mcmc___target=WarpedGaussian___kernel=MF.RWMH/summary.csv", df)
