...
# store output
mkdir("seed=4___target=Banana___flowtype=MF.DeterministicMixFlow___kernel=MF.RWMH___step_size=0.05___flow_length=2000")
CSV.write("seed=4___target=Banana___flowtype=MF.DeterministicMixFlow___kernel=MF.RWMH___step_size=0.05___flow_length=2000/summary.csv", df)
