...
# store output
mkdir("seed=12___tracetype=fwd_homo___target=Banana___kernel=MF.HMC")
CSV.write("seed=12___tracetype=fwd_homo___target=Banana___kernel=MF.HMC/summary.csv", df)
