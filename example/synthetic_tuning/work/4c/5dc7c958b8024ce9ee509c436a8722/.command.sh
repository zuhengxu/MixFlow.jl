...
# store output
mkdir("seed=19___target=Funnel___flowtype=MF.BackwardIRFMixFlow___kernel=MF.HMC___step_size=0.2___flow_length=200")
CSV.write("seed=19___target=Funnel___flowtype=MF.BackwardIRFMixFlow___kernel=MF.HMC___step_size=0.2___flow_length=200/summary.csv", df)
