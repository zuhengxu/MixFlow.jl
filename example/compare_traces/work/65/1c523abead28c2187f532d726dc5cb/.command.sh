...
# store output
mkdir("seed=27___tracetype=fwd_homo___target=WarpedGaussian___kernel=MF.HMC")
CSV.write("seed=27___tracetype=fwd_homo___target=WarpedGaussian___kernel=MF.HMC/summary.csv", df)
