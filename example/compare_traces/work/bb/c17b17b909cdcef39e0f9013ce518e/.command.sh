...
# store output
mkdir("seed=12___tracetype=mcmc___target=WarpedGaussian___kernel=MF.HMC")
CSV.write("seed=12___tracetype=mcmc___target=WarpedGaussian___kernel=MF.HMC/summary.csv", df)
