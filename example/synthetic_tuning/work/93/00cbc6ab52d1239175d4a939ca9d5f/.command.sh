...
# store output
mkdir("seed=14___target=Cross___flowtype=MF.DeterministicMixFlow___kernel=MF.HMC___step_size=0.05___flow_length=200")
CSV.write("seed=14___target=Cross___flowtype=MF.DeterministicMixFlow___kernel=MF.HMC___step_size=0.05___flow_length=200/summary.csv", df)
