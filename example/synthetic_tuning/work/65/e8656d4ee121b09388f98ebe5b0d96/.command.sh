...
# store output
mkdir("seed=1___target=Cross___flowtype=MF.DeterministicMixFlow___kernel=MF.RWMH___step_size=0.2___flow_length=300")
CSV.write("seed=1___target=Cross___flowtype=MF.DeterministicMixFlow___kernel=MF.RWMH___step_size=0.2___flow_length=300/summary.csv", df)
