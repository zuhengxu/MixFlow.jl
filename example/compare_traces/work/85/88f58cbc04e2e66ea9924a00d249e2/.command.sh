...
# store output
mkdir("seed=16___tracetype=mcmc___target=WarpedGaussian___kernel=MF.RWMH")
CSV.write("seed=16___tracetype=mcmc___target=WarpedGaussian___kernel=MF.RWMH/summary.csv", df)
