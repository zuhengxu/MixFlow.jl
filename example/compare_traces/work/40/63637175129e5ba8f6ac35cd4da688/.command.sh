...
# store output
mkdir("seed=2___tracetype=bwd_inv_irf___target=Cross___kernel=MF.HMC")
CSV.write("seed=2___tracetype=bwd_inv_irf___target=Cross___kernel=MF.HMC/summary.csv", df)
