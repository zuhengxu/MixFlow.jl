...
# store output
mkdir("seed=11___tracetype=mcmc___target=WarpedGaussian___kernel=MF.RWMH")
CSV.write("seed=11___tracetype=mcmc___target=WarpedGaussian___kernel=MF.RWMH/summary.csv", df)
