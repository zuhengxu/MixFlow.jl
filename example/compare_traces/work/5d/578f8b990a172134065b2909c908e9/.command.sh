...
# store output
mkdir("seed=24___tracetype=bwd_inv_irf___target=Cross___kernel=MF.MALA")
CSV.write("seed=24___tracetype=bwd_inv_irf___target=Cross___kernel=MF.MALA/summary.csv", df)
