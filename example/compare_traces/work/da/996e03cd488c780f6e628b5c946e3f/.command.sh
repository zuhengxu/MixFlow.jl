...
# store output
mkdir("seed=5___tracetype=mcmc___target=WarpedGaussian___kernel=MF.RWMH")
CSV.write("seed=5___tracetype=mcmc___target=WarpedGaussian___kernel=MF.RWMH/summary.csv", df)
