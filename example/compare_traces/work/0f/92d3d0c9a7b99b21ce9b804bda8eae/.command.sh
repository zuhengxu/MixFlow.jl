...
# store output
mkdir("seed=12___tracetype=inv_irf___target=WarpedGaussian___kernel=MF.RWMH")
CSV.write("seed=12___tracetype=inv_irf___target=WarpedGaussian___kernel=MF.RWMH/summary.csv", df)
