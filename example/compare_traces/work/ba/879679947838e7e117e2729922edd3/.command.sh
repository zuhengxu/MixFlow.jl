...
# store output
mkdir("seed=11___tracetype=bwd_inv_irf___target=Cross___kernel=MF.HMC")
CSV.write("seed=11___tracetype=bwd_inv_irf___target=Cross___kernel=MF.HMC/summary.csv", df)
