...
# store output
mkdir("seed=4___tracetype=mcmc___target=WarpedGaussian___kernel=MF.RWMH")
CSV.write("seed=4___tracetype=mcmc___target=WarpedGaussian___kernel=MF.RWMH/summary.csv", df)
