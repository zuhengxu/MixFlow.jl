...
# store output
mkdir("seed=14___tracetype=mcmc___target=WarpedGaussian___kernel=MF.MALA")
CSV.write("seed=14___tracetype=mcmc___target=WarpedGaussian___kernel=MF.MALA/summary.csv", df)
