...
# store output
mkdir("seed=2___kernel=MF.HMC___step_size=0.1___flow_length=150___target=Cross___flowtype=MF.DeterministicMixFlow")
CSV.write("seed=2___kernel=MF.HMC___step_size=0.1___flow_length=150___target=Cross___flowtype=MF.DeterministicMixFlow/summary.csv", df)
