...
# store output
mkdir("seed=32___tracetype=bwd_inv_irf___target=Banana___kernel=MF.MALA")
CSV.write("seed=32___tracetype=bwd_inv_irf___target=Banana___kernel=MF.MALA/summary.csv", df)
