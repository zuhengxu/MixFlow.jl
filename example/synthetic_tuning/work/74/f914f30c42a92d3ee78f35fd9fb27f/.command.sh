...
# store output
mkdir("seed=4___kernel=MF.HMC___step_size=0.2___flow_length=150___target=Cross___flowtype=MF.IRFMixFlow")
CSV.write("seed=4___kernel=MF.HMC___step_size=0.2___flow_length=150___target=Cross___flowtype=MF.IRFMixFlow/summary.csv", df)
