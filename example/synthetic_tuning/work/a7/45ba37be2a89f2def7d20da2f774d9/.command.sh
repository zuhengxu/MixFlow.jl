...
# store output
mkdir("seed=1___target=Cross___flowtype=MF.IRFMixFlow___kernel=MF.MALA___step_size=0.2___flow_length=2000")
CSV.write("seed=1___target=Cross___flowtype=MF.IRFMixFlow___kernel=MF.MALA___step_size=0.2___flow_length=2000/summary.csv", df)
