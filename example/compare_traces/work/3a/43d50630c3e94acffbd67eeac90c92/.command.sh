...
# store output
mkdir("seed=25___tracetype=bwd_irf___target=WarpedGaussian___kernel=MF.RWMH")
CSV.write("seed=25___tracetype=bwd_irf___target=WarpedGaussian___kernel=MF.RWMH/summary.csv", df)
