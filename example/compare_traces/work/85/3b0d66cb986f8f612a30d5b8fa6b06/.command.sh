...
# store output
mkdir("seed=23___tracetype=mcmc___target=WarpedGaussian___kernel=MF.MALA")
CSV.write("seed=23___tracetype=mcmc___target=WarpedGaussian___kernel=MF.MALA/summary.csv", df)
