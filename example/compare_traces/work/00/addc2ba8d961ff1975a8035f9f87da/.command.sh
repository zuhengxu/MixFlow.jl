...
# store output
mkdir("seed=26___tracetype=fwd_homo___target=Funnel___kernel=MF.HMC")
CSV.write("seed=26___tracetype=fwd_homo___target=Funnel___kernel=MF.HMC/summary.csv", df)
