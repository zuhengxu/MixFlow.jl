...
# store output
mkdir("seed=18___tracetype=mcmc___target=WarpedGaussian___kernel=MF.MALA")
CSV.write("seed=18___tracetype=mcmc___target=WarpedGaussian___kernel=MF.MALA/summary.csv", df)
