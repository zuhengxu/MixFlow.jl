...
# store output
mkdir("seed=27___tracetype=bwd_irf___target=Banana___kernel=MF.MALA")
CSV.write("seed=27___tracetype=bwd_irf___target=Banana___kernel=MF.MALA/summary.csv", df)
