...
# store output
mkdir("seed=16___tracetype=fwd_irf___target=Banana___kernel=MF.MALA")
CSV.write("seed=16___tracetype=fwd_irf___target=Banana___kernel=MF.MALA/summary.csv", df)
