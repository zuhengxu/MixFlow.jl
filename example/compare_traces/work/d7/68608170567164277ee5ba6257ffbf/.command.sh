...
# store output
mkdir("seed=5___tracetype=bwd_inv_irf___target=Banana___kernel=MF.RWMH")
CSV.write("seed=5___tracetype=bwd_inv_irf___target=Banana___kernel=MF.RWMH/summary.csv", df)
