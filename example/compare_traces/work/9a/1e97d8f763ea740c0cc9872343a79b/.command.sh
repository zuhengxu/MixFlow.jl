...
# store output
mkdir("seed=15___tracetype=bwd_inv_irf___target=Funnel___kernel=MF.RWMH")
CSV.write("seed=15___tracetype=bwd_inv_irf___target=Funnel___kernel=MF.RWMH/summary.csv", df)
