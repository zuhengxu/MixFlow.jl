...
# store output
mkdir("seed=2___target=Cross___flowtype=MF.DeterministicMixFlow___kernel=MF.RWMH___step_size=0.2___flow_length=3000")
CSV.write("seed=2___target=Cross___flowtype=MF.DeterministicMixFlow___kernel=MF.RWMH___step_size=0.2___flow_length=3000/summary.csv", df)
