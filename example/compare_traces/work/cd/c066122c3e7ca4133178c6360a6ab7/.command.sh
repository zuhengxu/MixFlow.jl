...
# store output
mkdir("seed=21___tracetype=mcmc___target=WarpedGaussian___kernel=MF.RWMH")
CSV.write("seed=21___tracetype=mcmc___target=WarpedGaussian___kernel=MF.RWMH/summary.csv", df)
