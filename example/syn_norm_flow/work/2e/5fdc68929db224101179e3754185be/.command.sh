...
# store output
mkdir("seed=1___target=Banana___flowtype=real_nvp___lr=1e-3___batchsize=64___niters=10")
CSV.write("seed=1___target=Banana___flowtype=real_nvp___lr=1e-3___batchsize=64___niters=10/summary.csv", df)
