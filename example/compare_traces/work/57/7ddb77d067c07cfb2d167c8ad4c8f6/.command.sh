...
# store output
mkdir("seed=12___tracetype=bwd_inv_irf___target=Cross___kernel=MF.RWMH")
CSV.write("seed=12___tracetype=bwd_inv_irf___target=Cross___kernel=MF.RWMH/summary.csv", df)
