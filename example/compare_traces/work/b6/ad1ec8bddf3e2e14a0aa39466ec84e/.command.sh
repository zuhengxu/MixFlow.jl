...
# store output
mkdir("seed=6___tracetype=fwd_homo___target=Funnel___kernel=MF.MALA")
CSV.write("seed=6___tracetype=fwd_homo___target=Funnel___kernel=MF.MALA/summary.csv", df)
