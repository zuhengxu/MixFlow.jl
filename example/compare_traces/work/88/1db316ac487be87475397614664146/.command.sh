...
# store output
mkdir("seed=3___tracetype=fwd_homo___target=Banana___kernel=MF.MALA")
CSV.write("seed=3___tracetype=fwd_homo___target=Banana___kernel=MF.MALA/summary.csv", df)
