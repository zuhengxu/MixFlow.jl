...
# store output
mkdir("seed=32___tracetype=mcmc___target=WarpedGaussian___kernel=MF.MALA")
CSV.write("seed=32___tracetype=mcmc___target=WarpedGaussian___kernel=MF.MALA/summary.csv", df)
