...
# store output
mkdir("seed=15___kernel=MF.HMC___step_size=0.1___flow_length=50___target=WarpedGaussian___flowtype=MF.BackwardIRFMixFlow")
CSV.write("seed=15___kernel=MF.HMC___step_size=0.1___flow_length=50___target=WarpedGaussian___flowtype=MF.BackwardIRFMixFlow/summary.csv", df)
