...
# store output
mkdir("seed=26___tracetype=inv_irf___target=Banana___kernel=MF.RWMH")
CSV.write("seed=26___tracetype=inv_irf___target=Banana___kernel=MF.RWMH/summary.csv", df)
