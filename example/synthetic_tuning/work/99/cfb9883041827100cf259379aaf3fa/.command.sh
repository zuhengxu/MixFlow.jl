...
# store output
mkdir("seed=2___target=Funnel___flowtype=MF.DeterministicMixFlow___kernel=MF.MALA___step_size=0.2___flow_length=2000")
CSV.write("seed=2___target=Funnel___flowtype=MF.DeterministicMixFlow___kernel=MF.MALA___step_size=0.2___flow_length=2000/summary.csv", df)
