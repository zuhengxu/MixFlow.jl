...
# store output
mkdir("seed=6___tracetype=fwd_irf___target=WarpedGaussian___kernel=MF.HMC")
CSV.write("seed=6___tracetype=fwd_irf___target=WarpedGaussian___kernel=MF.HMC/summary.csv", df)
