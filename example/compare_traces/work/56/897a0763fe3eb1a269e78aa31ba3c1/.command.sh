...
# store output
mkdir("seed=13___tracetype=fwd_homo___target=Funnel___kernel=MF.MALA")
CSV.write("seed=13___tracetype=fwd_homo___target=Funnel___kernel=MF.MALA/summary.csv", df)
