...
# store output
mkdir("seed=31___tracetype=mcmc___target=WarpedGaussian___kernel=MF.MALA")
CSV.write("seed=31___tracetype=mcmc___target=WarpedGaussian___kernel=MF.MALA/summary.csv", df)
