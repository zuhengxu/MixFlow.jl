...
# store output
mkdir("seed=30___tracetype=bwd_irf___target=Funnel___kernel=MF.MALA")
CSV.write("seed=30___tracetype=bwd_irf___target=Funnel___kernel=MF.MALA/summary.csv", df)
