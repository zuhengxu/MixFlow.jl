...
# store output
mkdir("seed=11___tracetype=inv_irf___target=Funnel___kernel=MF.RWMH")
CSV.write("seed=11___tracetype=inv_irf___target=Funnel___kernel=MF.RWMH/summary.csv", df)
