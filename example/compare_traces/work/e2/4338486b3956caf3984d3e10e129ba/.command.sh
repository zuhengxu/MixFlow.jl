...
# store output
mkdir("seed=8___tracetype=mcmc___target=WarpedGaussian___kernel=MF.HMC")
CSV.write("seed=8___tracetype=mcmc___target=WarpedGaussian___kernel=MF.HMC/summary.csv", df)
