...
# store output
mkdir("seed=22___tracetype=bwd_irf___target=WarpedGaussian___kernel=MF.HMC")
CSV.write("seed=22___tracetype=bwd_irf___target=WarpedGaussian___kernel=MF.HMC/summary.csv", df)
