...
# store output
mkdir("seed=5___target=Banana___flowtype=MF.BackwardIRFMixFlow___kernel=MF.HMC___step_size=0.01___flow_length=200")
CSV.write("seed=5___target=Banana___flowtype=MF.BackwardIRFMixFlow___kernel=MF.HMC___step_size=0.01___flow_length=200/summary.csv", df)
