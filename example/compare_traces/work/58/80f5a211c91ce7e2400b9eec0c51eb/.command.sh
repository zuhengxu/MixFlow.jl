...
# store output
mkdir("seed=19___tracetype=inv_irf___target=Funnel___kernel=MF.MALA")
CSV.write("seed=19___tracetype=inv_irf___target=Funnel___kernel=MF.MALA/summary.csv", df)
