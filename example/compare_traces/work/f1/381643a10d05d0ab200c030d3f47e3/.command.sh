...
# store output
mkdir("seed=13___tracetype=inv_irf___target=Banana___kernel=MF.MALA")
CSV.write("seed=13___tracetype=inv_irf___target=Banana___kernel=MF.MALA/summary.csv", df)
