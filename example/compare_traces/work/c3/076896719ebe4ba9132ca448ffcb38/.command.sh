...
# store output
mkdir("seed=23___tracetype=mcmc___target=WarpedGaussian___kernel=MF.RWMH")
CSV.write("seed=23___tracetype=mcmc___target=WarpedGaussian___kernel=MF.RWMH/summary.csv", df)
