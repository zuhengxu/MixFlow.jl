...
# store output
mkdir("seed=2___target=Banana___flowtype=MF.DeterministicMixFlow___kernel=MF.HMC___step_size=0.05___flow_length=200")
CSV.write("seed=2___target=Banana___flowtype=MF.DeterministicMixFlow___kernel=MF.HMC___step_size=0.05___flow_length=200/summary.csv", df)
