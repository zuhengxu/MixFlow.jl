...
# store output
mkdir("seed=27___tracetype=mcmc___target=WarpedGaussian___kernel=MF.RWMH")
CSV.write("seed=27___tracetype=mcmc___target=WarpedGaussian___kernel=MF.RWMH/summary.csv", df)
