...
# store output
mkdir("seed=19___tracetype=fwd_homo___target=Banana___kernel=MF.RWMH")
CSV.write("seed=19___tracetype=fwd_homo___target=Banana___kernel=MF.RWMH/summary.csv", df)
