...
# store output
mkdir("seed=2___target=Funnel___flowtype=MF.DeterministicMixFlow___kernel=MF.MALA___step_size=0.5___flow_length=3000")
CSV.write("seed=2___target=Funnel___flowtype=MF.DeterministicMixFlow___kernel=MF.MALA___step_size=0.5___flow_length=3000/summary.csv", df)
