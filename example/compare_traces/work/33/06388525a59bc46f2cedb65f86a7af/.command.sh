...
# store output
mkdir("seed=5___tracetype=bwd_irf___target=WarpedGaussian___kernel=MF.MALA")
CSV.write("seed=5___tracetype=bwd_irf___target=WarpedGaussian___kernel=MF.MALA/summary.csv", df)
