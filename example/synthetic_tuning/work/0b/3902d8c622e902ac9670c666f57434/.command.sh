...
# store output
mkdir("seed=13___kernel=MF.HMC___step_size=0.2___flow_length=150___target=Banana___flowtype=MF.BackwardIRFMixFlow")
CSV.write("seed=13___kernel=MF.HMC___step_size=0.2___flow_length=150___target=Banana___flowtype=MF.BackwardIRFMixFlow/summary.csv", df)
