...
# store output
mkdir("seed=10___target=Funnel___flowtype=MF.IRFMixFlow___kernel=MF.HMC___step_size=0.2___flow_length=200")
CSV.write("seed=10___target=Funnel___flowtype=MF.IRFMixFlow___kernel=MF.HMC___step_size=0.2___flow_length=200/summary.csv", df)
