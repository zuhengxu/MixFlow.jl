...
# store output
mkdir("seed=11___tracetype=fwd_homo___target=WarpedGaussian___kernel=MF.HMC")
CSV.write("seed=11___tracetype=fwd_homo___target=WarpedGaussian___kernel=MF.HMC/summary.csv", df)
