...
# store output
mkdir("seed=22___tracetype=bwd_inv_irf___target=Funnel___kernel=MF.HMC")
CSV.write("seed=22___tracetype=bwd_inv_irf___target=Funnel___kernel=MF.HMC/summary.csv", df)
