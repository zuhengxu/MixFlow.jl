...
# store output
mkdir("seed=22___tracetype=bwd_irf___target=Banana___kernel=MF.MALA")
CSV.write("seed=22___tracetype=bwd_irf___target=Banana___kernel=MF.MALA/summary.csv", df)
