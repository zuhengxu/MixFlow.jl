...
# store output
mkdir("seed=25___tracetype=inv_irf___target=WarpedGaussian___kernel=MF.HMC")
CSV.write("seed=25___tracetype=inv_irf___target=WarpedGaussian___kernel=MF.HMC/summary.csv", df)
