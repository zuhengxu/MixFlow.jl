...
# store output
mkdir("seed=4___target=Banana___flowtype=MF.DeterministicMixFlow___kernel=MF.RWMH___step_size=0.5___flow_length=3000")
CSV.write("seed=4___target=Banana___flowtype=MF.DeterministicMixFlow___kernel=MF.RWMH___step_size=0.5___flow_length=3000/summary.csv", df)
