...
# store output
mkdir("seed=13___tracetype=mcmc___target=WarpedGaussian___kernel=MF.HMC")
CSV.write("seed=13___tracetype=mcmc___target=WarpedGaussian___kernel=MF.HMC/summary.csv", df)
