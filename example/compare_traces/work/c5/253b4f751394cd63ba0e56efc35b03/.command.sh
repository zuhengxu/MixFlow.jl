...
# store output
mkdir("seed=24___tracetype=fwd_irf___target=WarpedGaussian___kernel=MF.RWMH")
CSV.write("seed=24___tracetype=fwd_irf___target=WarpedGaussian___kernel=MF.RWMH/summary.csv", df)
