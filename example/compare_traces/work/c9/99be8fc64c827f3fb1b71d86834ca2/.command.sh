...
# store output
mkdir("seed=19___tracetype=bwd_irf___target=Banana___kernel=MF.MALA")
CSV.write("seed=19___tracetype=bwd_irf___target=Banana___kernel=MF.MALA/summary.csv", df)
