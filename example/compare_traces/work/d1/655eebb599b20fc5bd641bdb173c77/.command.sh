...
# store output
mkdir("seed=22___tracetype=fwd_irf___target=Funnel___kernel=MF.RWMH")
CSV.write("seed=22___tracetype=fwd_irf___target=Funnel___kernel=MF.RWMH/summary.csv", df)
