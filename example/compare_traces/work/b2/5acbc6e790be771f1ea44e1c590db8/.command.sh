...
# store output
mkdir("seed=7___tracetype=mcmc___target=WarpedGaussian___kernel=MF.MALA")
CSV.write("seed=7___tracetype=mcmc___target=WarpedGaussian___kernel=MF.MALA/summary.csv", df)
