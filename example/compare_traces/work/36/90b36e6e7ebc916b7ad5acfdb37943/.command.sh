...
# store output
mkdir("seed=32___tracetype=bwd_irf___target=Banana___kernel=MF.RWMH")
CSV.write("seed=32___tracetype=bwd_irf___target=Banana___kernel=MF.RWMH/summary.csv", df)
