...
# store output
mkdir("seed=15___tracetype=fwd_homo___target=Funnel___kernel=MF.HMC")
CSV.write("seed=15___tracetype=fwd_homo___target=Funnel___kernel=MF.HMC/summary.csv", df)
