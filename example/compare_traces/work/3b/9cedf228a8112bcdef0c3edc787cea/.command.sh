...
# store output
mkdir("seed=6___tracetype=inv_irf___target=WarpedGaussian___kernel=MF.RWMH")
CSV.write("seed=6___tracetype=inv_irf___target=WarpedGaussian___kernel=MF.RWMH/summary.csv", df)
