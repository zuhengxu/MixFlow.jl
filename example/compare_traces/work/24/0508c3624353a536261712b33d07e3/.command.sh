...
# store output
mkdir("seed=17___tracetype=mcmc___target=WarpedGaussian___kernel=MF.HMC")
CSV.write("seed=17___tracetype=mcmc___target=WarpedGaussian___kernel=MF.HMC/summary.csv", df)
