...
# store output
mkdir("seed=21___tracetype=fwd_homo___target=WarpedGaussian___kernel=MF.MALA")
CSV.write("seed=21___tracetype=fwd_homo___target=WarpedGaussian___kernel=MF.MALA/summary.csv", df)
