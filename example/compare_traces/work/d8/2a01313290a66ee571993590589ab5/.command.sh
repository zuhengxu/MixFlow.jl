...
# store output
mkdir("seed=16___tracetype=bwd_inv_irf___target=Funnel___kernel=MF.HMC")
CSV.write("seed=16___tracetype=bwd_inv_irf___target=Funnel___kernel=MF.HMC/summary.csv", df)
