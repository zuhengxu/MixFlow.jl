...
# store output
mkdir("seed=7___kernel=MF.HMC___step_size=0.2___flow_length=150___target=Funnel___flowtype=MF.IRFMixFlow")
CSV.write("seed=7___kernel=MF.HMC___step_size=0.2___flow_length=150___target=Funnel___flowtype=MF.IRFMixFlow/summary.csv", df)
