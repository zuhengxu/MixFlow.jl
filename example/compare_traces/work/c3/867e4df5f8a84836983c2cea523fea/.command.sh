...
# store output
mkdir("seed=3___tracetype=inv_irf___target=WarpedGaussian___kernel=MF.MALA")
CSV.write("seed=3___tracetype=inv_irf___target=WarpedGaussian___kernel=MF.MALA/summary.csv", df)
