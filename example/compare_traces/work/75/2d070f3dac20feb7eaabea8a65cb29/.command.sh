...
# store output
mkdir("seed=12___tracetype=bwd_inv_irf___target=Cross___kernel=MF.MALA")
CSV.write("seed=12___tracetype=bwd_inv_irf___target=Cross___kernel=MF.MALA/summary.csv", df)
