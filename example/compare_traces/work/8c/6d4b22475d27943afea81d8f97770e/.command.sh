...
# store output
mkdir("seed=14___tracetype=bwd_irf___target=Funnel___kernel=MF.RWMH")
CSV.write("seed=14___tracetype=bwd_irf___target=Funnel___kernel=MF.RWMH/summary.csv", df)
