...
# store output
mkdir("seed=15___tracetype=bwd_irf___target=WarpedGaussian___kernel=MF.MALA")
CSV.write("seed=15___tracetype=bwd_irf___target=WarpedGaussian___kernel=MF.MALA/summary.csv", df)
