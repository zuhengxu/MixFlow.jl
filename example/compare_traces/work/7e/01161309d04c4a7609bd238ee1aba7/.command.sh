...
# store output
mkdir("seed=27___tracetype=bwd_inv_irf___target=Banana___kernel=MF.HMC")
CSV.write("seed=27___tracetype=bwd_inv_irf___target=Banana___kernel=MF.HMC/summary.csv", df)
