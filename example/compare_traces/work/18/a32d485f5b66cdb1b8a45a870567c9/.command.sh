...
# store output
mkdir("seed=24___tracetype=fwd_homo___target=Banana___kernel=MF.HMC")
CSV.write("seed=24___tracetype=fwd_homo___target=Banana___kernel=MF.HMC/summary.csv", df)
