...
# store output
mkdir("seed=2___tracetype=fwd_irf___target=WarpedGaussian___kernel=MF.HMC")
CSV.write("seed=2___tracetype=fwd_irf___target=WarpedGaussian___kernel=MF.HMC/summary.csv", df)
