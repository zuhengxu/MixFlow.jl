...
# store output
mkdir("seed=14___tracetype=mcmc___target=WarpedGaussian___kernel=MF.RWMH")
CSV.write("seed=14___tracetype=mcmc___target=WarpedGaussian___kernel=MF.RWMH/summary.csv", df)
