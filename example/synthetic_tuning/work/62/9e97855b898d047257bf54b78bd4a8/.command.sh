...
# store output
mkdir("seed=10___target=Funnel___flowtype=MF.BackwardIRFMixFlow___kernel=MF.HMC___step_size=0.1___flow_length=200")
CSV.write("seed=10___target=Funnel___flowtype=MF.BackwardIRFMixFlow___kernel=MF.HMC___step_size=0.1___flow_length=200/summary.csv", df)
