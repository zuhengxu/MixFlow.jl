...
# store output
mkdir("seed=1___target=Funnel___flowtype=MF.DeterministicMixFlow___kernel=MF.RWMH___step_size=0.05___flow_length=300")
CSV.write("seed=1___target=Funnel___flowtype=MF.DeterministicMixFlow___kernel=MF.RWMH___step_size=0.05___flow_length=300/summary.csv", df)
