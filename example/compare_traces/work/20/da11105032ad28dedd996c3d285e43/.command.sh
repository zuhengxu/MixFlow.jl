...
# store output
mkdir("seed=10___tracetype=fwd_homo___target=Cross___kernel=MF.MALA")
CSV.write("seed=10___tracetype=fwd_homo___target=Cross___kernel=MF.MALA/summary.csv", df)
