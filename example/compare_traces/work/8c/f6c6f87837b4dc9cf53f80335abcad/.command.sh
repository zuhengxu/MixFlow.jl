...
# store output
mkdir("seed=20___tracetype=mcmc___target=WarpedGaussian___kernel=MF.RWMH")
CSV.write("seed=20___tracetype=mcmc___target=WarpedGaussian___kernel=MF.RWMH/summary.csv", df)
