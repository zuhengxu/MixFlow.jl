...
# store output
mkdir("seed=2___tracetype=fwd_homo___target=WarpedGaussian___kernel=MF.HMC")
CSV.write("seed=2___tracetype=fwd_homo___target=WarpedGaussian___kernel=MF.HMC/summary.csv", df)
