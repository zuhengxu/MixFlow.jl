...
# store output
mkdir("seed=14___tracetype=fwd_irf___target=Banana___kernel=MF.MALA")
CSV.write("seed=14___tracetype=fwd_irf___target=Banana___kernel=MF.MALA/summary.csv", df)
