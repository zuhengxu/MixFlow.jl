...
# store output
mkdir("seed=30___tracetype=bwd_inv_irf___target=Funnel___kernel=MF.RWMH")
CSV.write("seed=30___tracetype=bwd_inv_irf___target=Funnel___kernel=MF.RWMH/summary.csv", df)
