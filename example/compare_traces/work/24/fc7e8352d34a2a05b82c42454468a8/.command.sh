...
# store output
mkdir("seed=3___tracetype=mcmc___target=WarpedGaussian___kernel=MF.HMC")
CSV.write("seed=3___tracetype=mcmc___target=WarpedGaussian___kernel=MF.HMC/summary.csv", df)
