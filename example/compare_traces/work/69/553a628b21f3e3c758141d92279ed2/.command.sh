...
# store output
mkdir("seed=17___tracetype=fwd_irf___target=Banana___kernel=MF.RWMH")
CSV.write("seed=17___tracetype=fwd_irf___target=Banana___kernel=MF.RWMH/summary.csv", df)
