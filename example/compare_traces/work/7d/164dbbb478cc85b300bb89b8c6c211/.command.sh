...
# store output
mkdir("seed=15___tracetype=fwd_homo___target=WarpedGaussian___kernel=MF.MALA")
CSV.write("seed=15___tracetype=fwd_homo___target=WarpedGaussian___kernel=MF.MALA/summary.csv", df)
