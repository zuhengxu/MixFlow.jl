...
# store output
mkdir("seed=2___target=Banana___flowtype=MF.BackwardIRFMixFlow___kernel=MF.MALA___step_size=0.05___flow_length=2000")
CSV.write("seed=2___target=Banana___flowtype=MF.BackwardIRFMixFlow___kernel=MF.MALA___step_size=0.05___flow_length=2000/summary.csv", df)
