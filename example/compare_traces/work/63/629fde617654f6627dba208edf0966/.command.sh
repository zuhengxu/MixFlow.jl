...
# store output
mkdir("seed=12___tracetype=inv_irf___target=Banana___kernel=MF.MALA")
CSV.write("seed=12___tracetype=inv_irf___target=Banana___kernel=MF.MALA/summary.csv", df)
