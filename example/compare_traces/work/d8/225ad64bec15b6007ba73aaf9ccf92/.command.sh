...
# store output
mkdir("seed=7___tracetype=bwd_irf___target=WarpedGaussian___kernel=MF.RWMH")
CSV.write("seed=7___tracetype=bwd_irf___target=WarpedGaussian___kernel=MF.RWMH/summary.csv", df)
