...
# store output
mkdir("seed=20___kernel=MF.HMC___step_size=0.2___flow_length=150___target=Banana___flowtype=MF.DeterministicMixFlow")
CSV.write("seed=20___kernel=MF.HMC___step_size=0.2___flow_length=150___target=Banana___flowtype=MF.DeterministicMixFlow/summary.csv", df)
