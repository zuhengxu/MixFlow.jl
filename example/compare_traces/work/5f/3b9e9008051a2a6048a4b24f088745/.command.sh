...
# store output
mkdir("seed=17___tracetype=fwd_homo___target=Funnel___kernel=MF.HMC")
CSV.write("seed=17___tracetype=fwd_homo___target=Funnel___kernel=MF.HMC/summary.csv", df)
